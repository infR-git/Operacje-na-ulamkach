...
// =========================
function dodaj() {
    let n1 = Number(document.getElementById("num2").value);
    let d1 = Number(document.getElementById("den2").value);
    let n2 = Number(document.getElementById("num3").value);
    let d2 = Number(document.getElementById("den3").value);
